...
$clientbirthdate = '';
$clientaddress = '';
$clientstatus = mysqli_real_escape_string($mysql, $_POST['status']);
$clientobs = '';
...
if ( empty($formpnome) or empty($formunome)	or empty($formemail) or empty($clientstatus) ) {
	...
	$usersql = "
		INSERT INTO at_clients (clientcompany, clientregister, clientfname, clientlname, clientmail, clienttel1, clienttel2, clienttel3, clientzap, clientbirthdate, clientaddress, clientstatus, clientobs)
		VALUES ('$usercompany', '$regdate', '$formpnome', '$formunome', '$formemail', '$clienttel1', '$clienttel2', '$clienttel3', '$clientzap', '$clientbirthdate', '$clientaddress', '$clientstatus', '$clientobs');
	";
